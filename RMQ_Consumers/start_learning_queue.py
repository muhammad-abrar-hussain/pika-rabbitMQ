...
START_LEARNING_QUEUE = 'queue.learn.presentation'
...
def main():
    ...
    def callback(ch, method, properties, body):
        ...
        db_save_topics(topics, presentation_id)

        print(f" [x] Topics saved for presentation {presentation_id}")

    channel.basic_consume(queue=START_LEARNING_QUEUE, on_message_callback=callback, auto_ack=True)
